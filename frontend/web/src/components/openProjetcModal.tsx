            ...
            <div
                ...
                <div className="p-4 border-b border-white/5 bg-[#0F0F0F]">
                    <div className="relative group">
                        <Search
                            className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-500 group-focus-within:text-neutral-400 transition-colors"/>
                        <input
                            type="text"
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start mb-0.5">
                                        <span
                                            className="font-semibold text-neutral-300 group-hover:text-white transition-colors truncate pr-2">
                                            {project.name}
                                        </span>
                                        <span
                                            className="text-[10px] text-neutral-500 flex items-center gap-1 font-mono bg-neutral-900 px-1.5 py-0.5 rounded border border-neutral-800 shrink-0">
                                            <Calendar size={10}/>
