...
export function App() {
	...
	return (
		<div className="flex flex-col h-screen w-screen bg-neutral-950 text-neutral-300 font-sans overflow-hidden p-3 gap-3 selection:bg-neutral-700 selection:text-white">

			{/* FLOATING TOP BAR */}
			<header className="flex items-center justify-between px-4 h-14 bg-neutral-900 border border-neutral-800/80 rounded-xl shadow-lg shadow-black/40 shrink-0 select-none">
				...
				<div className="flex items-center gap-2">
					...
					<button
						...
						title="Run Code"
					>
						<Play size={14} strokeWidth={3} className="fill-neutral-950 transition-transform group-hover:translate-x-0.5" />
						RUN
					</button>
				</div>
			</header>
			...
			<div className="flex flex-1 overflow-hidden">
				...
				>
					<div className="flex items-center gap-2 px-4 py-3 border-b border-neutral-800/60 bg-neutral-900 text-neutral-400">
					...
					<div className={`flex-1 p-3 text-sm text-neutral-500 font-mono overflow-auto ${scrollbarClasses}`}>
						...
						<div className="flex items-center gap-2 px-2 py-1.5 rounded bg-neutral-800/50 text-neutral-200 cursor-pointer">
				...
				>
					<div className="w-1 h-12 bg-neutral-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-[0_0_10px_rgba(255,255,255,0.1)]"></div>
				</div>
				...
				<div className="flex flex-col flex-1 overflow-hidden">
					...
					{/* FLOATING EDITOR */}
					<div className="flex flex-col flex-1 bg-neutral-900 border border-neutral-800/80 rounded-xl shadow-lg shadow-black/40 overflow-hidden relative">

						{/* Editor Breadcrumb Bar */}
						<div className="flex items-center px-4 h-9 bg-neutral-900/50 border-b border-neutral-800/60 select-none text-xs font-mono text-neutral-500">
						...
						{/* Editor Container */}
						<div className="absolute top-9 bottom-0 left-0 right-0 m-2 rounded-lg overflow-hidden bg-neutral-950 shadow-inner shadow-black">
							<MonacoEditor />
						</div>
					</div>
					...
					{isConsoleOpen && (
						...
						>
							<div className="h-1 w-12 bg-neutral-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-[0_0_10px_rgba(255,255,255,0.1)]"></div>
						</div>
					)}
					...
					{isConsoleOpen && (
						...
						>
							<div className="flex items-center justify-between px-4 h-10 border-b border-neutral-800/60 bg-neutral-900 select-none">
							...
							<div className={`flex-1 p-4 font-mono text-sm text-neutral-300 overflow-auto bg-neutral-950/40 shadow-inner shadow-black/20 ${scrollbarClasses}`}>
